...
#It appears first and gives options to the user to choose from.
    def Menu():
        ...
        if choice == 1:
            ...
            #Function found on line 11.
            mainmenu()

        #Menu option 2 code. Delete entry.
        elif choice == 2:
            #This is an opt out of deleting a user. 
            #If they hit this button by accident they can return to main menu
            response = print(input('Are you sure you want to delete an entry? y/n? Then enter:'))
            if response == 'y':
            ...
            if response == 'n':
                #Line 11
                mainmenu()
            #This if exception handling if the user types in anything besides a y or n
            else:
                print('You must type y or n, no caps.')
